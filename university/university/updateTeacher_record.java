...
public class updateTeacher_record extends JFrame implements ActionListener 
    ...
    updateTeacher_record(String sm)
    {
        ...
        l14=new JLabel("Update Teacher Details");
        l14.setFont(f);
  ...
  void trial(String sm)
  {
      try
      {
        ...
        String qq="select * from new_faculty where employ='"+sm+"'";
      ...
      public void actionPerformed(ActionEvent ev)  
        ...
        {
            connectionc obj=new connectionc();
              String q="update new_faculty set name='"+name+"',father_name='"+father_name+"',age='"+age+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',classX='"+classX+"',classXII='"+classXII+"',employ ID='"+employ+"',department='"+department+"',cource='"+cource+"')";
